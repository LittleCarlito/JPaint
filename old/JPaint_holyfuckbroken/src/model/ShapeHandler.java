...
public class ShapeHandler {
	...
	public static IShape outlineWrap(IShape shape) {
		return new OutlinedShape(shape);
	}
	
	public static IShape unwrap(IShape shape) {
		return shape.getClone(shape.getColor(), shape.getShade(), shape.getOrigin(), shape.getWidth(), shape.getHeight());
	}
}
